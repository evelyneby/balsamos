...
$username = "if0_36426806";
$password = "woYSj4UllAcxLu"; // Reemplaza 'TuContraseñaDevPanel' con tu contraseña real del vPanel
$database = "if0_36426806_balsamos";
                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($resultado) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($resultado)) {
                                ...
                                echo $texto_utf8;
                                echo '<h5 class="fw-bolder">' .  $texto_utf8. '</h5>';
